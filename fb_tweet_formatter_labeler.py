...
eval_formatting = '{seq1}|{l1}|{seq3}|{l3}\n'
lines = []
percent_dev = 0.80
...
comp_data = open('convo_collect/collected_convos.txt', 'r')
test_data = open('collected_test_data_to_label.txt', 'a')
...
test_data.write('turn1|seq1_length|turn3|seq3_length\n')
